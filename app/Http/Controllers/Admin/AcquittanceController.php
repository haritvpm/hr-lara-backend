...
class AcquittanceController extends Controller
{
    ...
    public function index()
    {
        ...
        $acquittances = Acquittance::with(['office'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.acquittances.create', compact('offices'));
    }
    ...
    public function edit(Acquittance $acquittance)
    {
        ...
        $acquittance->load('office');

        return view('admin.acquittances.edit', compact('acquittance', 'offices'));
    }
