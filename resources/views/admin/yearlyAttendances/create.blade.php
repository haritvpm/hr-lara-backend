...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.yearlyAttendance.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.yearly-attendances.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cl_submitted') ? 'is-invalid' : '' }}" type="number" name="cl_submitted" id="cl_submitted" value="{{ old('cl_submitted', '') }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('compen_submitted') ? 'is-invalid' : '' }}" type="number" name="compen_submitted" id="compen_submitted" value="{{ old('compen_submitted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_leaves_marked') ? 'is-invalid' : '' }}" type="number" name="other_leaves_marked" id="other_leaves_marked" value="{{ old('other_leaves_marked', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_leaves_submitted') ? 'is-invalid' : '' }}" type="number" name="other_leaves_submitted" id="other_leaves_submitted" value="{{ old('other_leaves_submitted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('single_punchings_regularised') ? 'is-invalid' : '' }}" type="number" name="single_punchings_regularised" id="single_punchings_regularised" value="{{ old('single_punchings_regularised', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unauthorised_count') ? 'is-invalid' : '' }}" type="number" name="unauthorised_count" id="unauthorised_count" value="{{ old('unauthorised_count', '') }}" step="1">
