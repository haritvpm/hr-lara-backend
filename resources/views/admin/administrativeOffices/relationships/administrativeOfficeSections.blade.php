    ...
    <div class="card_">
        ...
        <div class="card-body_">
            <div class="table-responsive_">
                <table class=" table   table-hover datatable datatable-administrativeOfficeSections">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-administrativeOfficeSections:not(.ajaxTable)').DataTable({ buttons: dtButtons })
