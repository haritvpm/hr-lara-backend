...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.leaveFormDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.leave-form-details.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post') ? 'is-invalid' : '' }}" type="text" name="post" id="post" value="{{ old('post', '') }}">
                @if($errors->has('post'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dept') ? 'is-invalid' : '' }}" type="text" name="dept" id="dept" value="{{ old('dept', '') }}">
                @if($errors->has('dept'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay') ? 'is-invalid' : '' }}" type="text" name="pay" id="pay" value="{{ old('pay', '') }}">
                @if($errors->has('pay'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('doe') ? 'is-invalid' : '' }}" type="text" name="doe" id="doe" value="{{ old('doe') }}">
                @if($errors->has('doe'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_confirmation') ? 'is-invalid' : '' }}" type="text" name="date_of_confirmation" id="date_of_confirmation" value="{{ old('date_of_confirmation') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_leave_info') ? 'is-invalid' : '' }}" type="text" name="last_leave_info" id="last_leave_info" value="{{ old('last_leave_info', '') }}">
