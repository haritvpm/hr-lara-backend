...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.compenGranted.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.compen-granteds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_work') ? 'is-invalid' : '' }}" type="text" name="date_of_work" id="date_of_work" value="{{ old('date_of_work') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_for_extra_hours') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_for_extra_hours" id="is_for_extra_hours" value="1" {{ old('is_for_extra_hours', 0) == 1 ? 'checked' : '' }}>
