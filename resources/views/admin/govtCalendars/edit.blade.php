        ...
        <form method="POST" action="{{ route("admin.govt-calendars.update", [$govtCalendar->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('attendance_trace_fetch_complete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="attendance_trace_fetch_complete" id="attendance_trace_fetch_complete" value="1" {{ $govtCalendar->attendance_trace_fetch_complete || old('attendance_trace_fetch_complete', 0) === 1 ? 'checked' : '' }}>
