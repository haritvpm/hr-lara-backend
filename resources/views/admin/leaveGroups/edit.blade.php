...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.leaveGroup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.leave-groups.update", [$leaveGroup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="groupname">{{ trans('cruds.leaveGroup.fields.groupname') }}</label>
                <input class="form-control {{ $errors->has('groupname') ? 'is-invalid' : '' }}" type="text" name="groupname" id="groupname" value="{{ old('groupname', $leaveGroup->groupname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_casual_per_year') ? 'is-invalid' : '' }}" type="number" name="allowed_casual_per_year" id="allowed_casual_per_year" value="{{ old('allowed_casual_per_year', $leaveGroup->allowed_casual_per_year) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_compen_per_year') ? 'is-invalid' : '' }}" type="number" name="allowed_compen_per_year" id="allowed_compen_per_year" value="{{ old('allowed_compen_per_year', $leaveGroup->allowed_compen_per_year) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_special_casual_per_year') ? 'is-invalid' : '' }}" type="number" name="allowed_special_casual_per_year" id="allowed_special_casual_per_year" value="{{ old('allowed_special_casual_per_year', $leaveGroup->allowed_special_casual_per_year) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_earned_per_year') ? 'is-invalid' : '' }}" type="text" name="allowed_earned_per_year" id="allowed_earned_per_year" value="{{ old('allowed_earned_per_year', $leaveGroup->allowed_earned_per_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_halfpay_per_year') ? 'is-invalid' : '' }}" type="number" name="allowed_halfpay_per_year" id="allowed_halfpay_per_year" value="{{ old('allowed_halfpay_per_year', $leaveGroup->allowed_halfpay_per_year) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowed_continuous_casual_and_compen') ? 'is-invalid' : '' }}" type="number" name="allowed_continuous_casual_and_compen" id="allowed_continuous_casual_and_compen" value="{{ old('allowed_continuous_casual_and_compen', $leaveGroup->allowed_continuous_casual_and_compen) }}" step="1">
