...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.flexiApplication.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.flexi-applications.update", [$flexiApplication->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('employee') ? 'is-invalid' : '' }}" name="employee_id" id="employee_id">
                    @foreach($employees as $id => $entry)
                        <option value="{{ $id }}" {{ (old('employee_id') ? old('employee_id') : $flexiApplication->employee->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhaarid') ? 'is-invalid' : '' }}" type="text" name="aadhaarid" id="aadhaarid" value="{{ old('aadhaarid', $flexiApplication->aadhaarid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('flexi_minutes') ? 'is-invalid' : '' }}" type="number" name="flexi_minutes" id="flexi_minutes" value="{{ old('flexi_minutes', $flexiApplication->flexi_minutes) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('with_effect_from') ? 'is-invalid' : '' }}" type="text" name="with_effect_from" id="with_effect_from" value="{{ old('with_effect_from', $flexiApplication->with_effect_from) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('owner_seat') ? 'is-invalid' : '' }}" type="text" name="owner_seat" id="owner_seat" value="{{ old('owner_seat', $flexiApplication->owner_seat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('approved_by') ? 'is-invalid' : '' }}" type="text" name="approved_by" id="approved_by" value="{{ old('approved_by', $flexiApplication->approved_by) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('approved_on') ? 'is-invalid' : '' }}" type="text" name="approved_on" id="approved_on" value="{{ old('approved_on', $flexiApplication->approved_on) }}">
