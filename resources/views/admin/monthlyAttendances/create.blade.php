    ...
    <div class="card-body_">
        <form method="POST" action="{{ route("admin.monthly-attendances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('month') ? 'is-invalid' : '' }}" type="text" name="month" id="month" value="{{ old('month') }}" required>
                @if($errors->has('month'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cl') ? 'is-invalid' : '' }}" type="number" name="total_cl" id="total_cl" value="{{ old('total_cl', '') }}" step="0.1" max="20">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_compen') ? 'is-invalid' : '' }}" type="number" name="total_compen" id="total_compen" value="{{ old('total_compen', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_compen_off_granted') ? 'is-invalid' : '' }}" type="number" name="total_compen_off_granted" id="total_compen_off_granted" value="{{ old('total_compen_off_granted', '') }}" step="1">
