    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leaves.update", [$leaf->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('creation_date') ? 'is-invalid' : '' }}" type="text" name="creation_date" id="creation_date" value="{{ old('creation_date', $leaf->creation_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('created_by_aadhaarid') ? 'is-invalid' : '' }}" type="text" name="created_by_aadhaarid" id="created_by_aadhaarid" value="{{ old('created_by_aadhaarid', $leaf->created_by_aadhaarid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('owner_seat') ? 'is-invalid' : '' }}" type="text" name="owner_seat" id="owner_seat" value="{{ old('owner_seat', $leaf->owner_seat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text" name="remarks" id="remarks" value="{{ old('remarks', $leaf->remarks) }}">
