    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.punchings.update", [$punching->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grace_lp_exceeded_one_hour') ? 'is-invalid' : '' }}" type="number" name="grace_lp_exceeded_one_hour" id="grace_lp_exceeded_one_hour" value="{{ old('grace_lp_exceeded_one_hour', $punching->grace_lp_exceeded_one_hour) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grace_ep_exceeded_one_hour') ? 'is-invalid' : '' }}" type="number" name="grace_ep_exceeded_one_hour" id="grace_ep_exceeded_one_hour" value="{{ old('grace_ep_exceeded_one_hour', $punching->grace_ep_exceeded_one_hour) }}" step="1">
