...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employeeExtra.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-extras.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_joining_kla') ? 'is-invalid' : '' }}" type="text" name="date_of_joining_kla" id="date_of_joining_kla" value="{{ old('date_of_joining_kla') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('klaid') ? 'is-invalid' : '' }}" type="text" name="klaid" id="klaid" value="{{ old('klaid', '') }}" required>
                @if($errors->has('klaid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('electionid') ? 'is-invalid' : '' }}" type="text" name="electionid" id="electionid" value="{{ old('electionid', '') }}" required>
