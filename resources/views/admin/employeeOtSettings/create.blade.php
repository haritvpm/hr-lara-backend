...
<div class="card_">
    <div class="card-header_">
        {{ trans('global.create') }} {{ trans('cruds.employeeOtSetting.title_singular') }}
    </div>

    <div class="card-body_">
        <form method="POST" action="{{ route("admin.employee-ot-settings.store") }}" enctype="multipart/form-data">
            @csrf
