    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.designations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('default_time_group') ? 'is-invalid' : '' }}" name="default_time_group_id" id="default_time_group_id">
                    @foreach($default_time_groups as $id => $entry)
                        <option value="{{ $id }}" {{ old('default_time_group_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_without_grade') ? 'is-invalid' : '' }}" type="text" name="designation_without_grade" id="designation_without_grade" value="{{ old('designation_without_grade', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation_without_grade_mal') ? 'is-invalid' : '' }}" type="text" name="designation_without_grade_mal" id="designation_without_grade_mal" value="{{ old('designation_without_grade_mal', '') }}">
