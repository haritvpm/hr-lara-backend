...
class AddRelationshipFieldsToSectionsTable extends Migration
{
    public function up()
    {
        Schema::table('sections', function (Blueprint $table) {
            $table->unsignedBigInteger('seat_of_controlling_officer_id')->nullable();
            $table->foreign('seat_of_controlling_officer_id', 'seat_of_controlling_officer_fk_9671502')->references('id')->on('seats');
            ...
            $table->foreign('js_as_ss_employee_id', 'js_as_ss_employee_fk_9668077')->references('id')->on('employees');
        });
    }
}
